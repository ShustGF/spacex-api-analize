...
class LaunchesSpaceX(Base):
    ...
    def __init__(self, fairings=None, links=None, static_fire_date_utc=None,
                 static_fire_date_unix=None, tbd=None, net=None, window=None,
                 rocket=None, success=None, failures=[], details=None,
                 crew=None, ships=None, capsules=None, payloads=None,
                 launchpad=None, auto_update=None, flight_number=None,
                 name=None, date_utc=None, date_unix=None, date_local=None,
...
class Capsules(Base):
    ...
    def __init__(self, reuse_count=None, water_landings=None,
                 land_landings=None, last_update=None, launches=None,
                 serial=None, status=None, type=None, id=None):
...
class Cores(Base):
    ...
    def __init__(self, block=None, reuse_count=None, rtls_attempts=None,
                 rtls_landings=None, asds_attempts=None, asds_landings=None,
                 last_update=None, launches=None, serial=None, status=None,
                 id=None):
        self.block = block
        self.reuse_count = reuse_count
